...
export const Campaigns: React.FC = () => {
  ...
  const handleAIGeneration = () => {
    ...
    toast.success(t('admin.ui.feedback.generated'), { icon: '🤖' });
  };
  ...
  return (
    <div className="space-y-10 pb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-4xl font-serif font-bold text-gray-800 dark:text-white uppercase tracking-tighter">{t('admin.marketing')} <span className="text-pink-500 font-sans tracking-normal opacity-50 font-light ml-2">/ Campaigns</span></h1>
        ...
        >
          <Plus size={16} /> {t('admin.ui.buttons.add_campaign')}
        </button>
      </div>
        ...
        <div className="overflow-x-auto">
          {loading ? (
            ...
            <div className="py-20 text-center opacity-30">
              ...
              <p className="text-[10px] font-black uppercase tracking-widest text-gray-500">{t('admin.ui.empty.campaigns')}</p>
            </div>
          ) : (
