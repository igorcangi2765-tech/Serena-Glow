            ...
            <div className="bg-white p-6 md:p-10 rounded-2xl shadow-md border border-pink-50">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4 group cursor-default">
                  <div className="w-12 h-12 rounded-full bg-pink-100 flex items-center justify-center shrink-0 transition-all duration-300 group-hover:bg-pink-500 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-pink-200">
                    <MapPin className="w-6 h-6 text-pink-500 transition-colors duration-300 group-hover:text-white" />
                  </div>
                ...
                <div className="flex items-start gap-4 group cursor-default">
                  <div className="w-12 h-12 rounded-full bg-pink-100 flex items-center justify-center shrink-0 transition-all duration-300 group-hover:bg-pink-500 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-pink-200">
                    <Phone className="w-6 h-6 text-pink-500 transition-colors duration-300 group-hover:text-white" />
                  </div>
                  <div className="transition-transform duration-300 group-hover:translate-x-1">
                ...
                <div className="flex items-start gap-4 group cursor-default">
                  <div className="w-12 h-12 rounded-full bg-pink-100 flex items-center justify-center shrink-0 transition-all duration-300 group-hover:bg-pink-500 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-pink-200">
                    <Mail className="w-6 h-6 text-pink-500 transition-colors duration-300 group-hover:text-white" />
                  </div>
                  <div className="transition-transform duration-300 group-hover:translate-x-1">
                ...
                <div className="flex items-start gap-4 group cursor-default">
                  <div className="w-12 h-12 rounded-full bg-pink-100 flex items-center justify-center shrink-0 transition-all duration-300 group-hover:bg-pink-500 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-pink-200">
                    <Clock className="w-6 h-6 text-pink-500 transition-colors duration-300 group-hover:text-white" />
                  </div>
                  <div className="transition-transform duration-300 group-hover:translate-x-1">
