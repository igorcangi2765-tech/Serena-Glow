          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service: any, idx: number) => (
              <motion.div 
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: idx * 0.1 }}
                className="bg-white dark:bg-[#1E1E1E] p-8 rounded-2xl shadow-md hover:shadow-xl transition duration-300 group cursor-pointer border border-pink-100 dark:border-[#2E2E2E]"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {gallery.slice(0, 6).map((img: string, idx: number) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: idx * 0.1 }}
                className="relative overflow-hidden group shadow-md hover:shadow-xl transition duration-300"
              >
                <img
                  src={img}
