...
export const Booking: React.FC = () => {
  ...
  return (
    <div className="pt-24 w-full bg-pink-50/50 min-h-screen flex items-center justify-center">
      <div className="max-w-3xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white p-10 md:p-16 rounded-3xl shadow-xl border border-pink-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-pink-500 to-rose-500 text-white py-4 rounded-full font-medium tracking-wide hover:shadow-lg transition-shadow shadow-md mt-8 font-sans"
            >
              {t.booking.confirm}
            </button>
          </form>
